...
ARG ROS_MADAIR_VERSION=v0.1.0-alpha.4
...
RUN python3 utils/unify.py && npx --node-options=--max-old-space-size=4096 starches-builder etl --file ./prebuild/business_data/a_all.json --prefix cat- --summary --include-private --build-ros-madair --ros-madair-bin ros-madair-build --ros-madair-output static/definitions/ros-madair
